...
/**
 * Todos os tratamentos e funcionalidades do server são feitios aqui
 */
public class UserHandler implements Runnable {

    public static List<UserHandler> clients = new ArrayList<>();
    private Socket socket;
    private BufferedReader reader;
    private BufferedWriter writer;
    private static final int MAXIMO_JOGADORES = 2;
    ...
    public UserHandler(Socket socket) {
        try {
            ...
            // Convertem os streams de bytes para letras
    ...
    /**
     * Envia uma mensagem para todos os clientes conectados, exceto o que a enviou.
     * Se addPrefix for true, adiciona um prefixo para indicar se o cliente é um
     * jogador ou espectador. Caso ocorra um erro durante o envio, a conexão com o
     * cliente é encerrada.
     * 
     * @param message
     *            A mensagem a ser enviada.
     * @param addPrefix
     *            Indica se o prefixo deve ser adicionado.
     */
    ...
    /**
     * Envia uma mensagem para todos os clientes conectados ao servidor. A mensagem
     * é prefixada com "🖥️:" para indicar que é do servidor. Se ocorrer um erro
     * durante o envio, a conexão com o cliente é encerrada.
     * 
     * @param message
     *            Mensagem a ser enviada para todos os clientes.
     */
     ...
     * 
     * @param message
     *            A mensagem a ser enviada ao cliente.
     */
     ...
     * 
     * O método considera que os primeiros {@code MAXIMO_JOGADORES} clientes na
     * lista são
     * jogadores,
    ...
    public boolean isPlayer() {
        return clients.indexOf(this) < MAXIMO_JOGADORES; // Verifica se é um jogador ou espectador.
    }
    ...
    public void userJoined() {
        ...
        if (isPlayer())
            broadcastMessage("🖥️: " + nome + " entrou na partida 🎮!", false);
        else
            broadcastMessage("🖥️: " + nome + " está assistindo à partida 👀!", false);
    }
    ...
    public void userLeft() {
        ...
        broadcastMessage("🖥️: " + nome + " saiu do servidor 😔!", false);
        System.out.println(nome + " saiu do servidor!"); // Log no servidor.
    }
     ...
     * 
     * @param socket
     *            O socket de conexão que será fechado.
     * @param reader
     *            O BufferedReader usado para ler dados do client.
     * @param writer
     *            O BufferedWriter usado para enviar dados ao client.
     */
     ...
     * 
     * @param command
     *            O comando executado pelo jogador. Pode ser "/pedra", "/papel",
     *            "/tesoura", ou "/jogar".
     */
    public void playerCommand(String command) {
        ...
        broadcastMessage("📢: " + nome + " escolheu sua jogada.", false);
    }
    ...
    public void play() {
        ...
        for (UserHandler client : clients) {
            if (!client.equals(this) && client.isPlayer() && client.playerChoice == null) {
                sendMessageToClient(client.nome + " ainda não fez sua jogada.");
                return;
            }
        }
    ...
    public void calculateResult() {
        ...
        UserHandler player1 = clients.get(0);
        UserHandler player2 = clients.get(1);
        ...
        if ((player1.playerChoice.equals("pedra") && player2.playerChoice.equals("tesoura")) ||
            ...
            sendServerMessage(
                    player1.nome + " venceu! (" + player1.playerChoice + " vs. " + player2.playerChoice + ") 🔥!");
        } else {
            sendServerMessage(
                    player2.nome + " venceu! (" + player2.playerChoice + " vs. " + player1.playerChoice + ") 🔥!");
        }
    ...
    public void resetGame() {
        ...
        for (int i = 0; i < clients.size(); i++) {
            UserHandler client = clients.get(i);
